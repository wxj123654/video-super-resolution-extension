...
let cachedFp16Support: boolean | null = null;

export function supportsFp16(adapter: GPUAdapter): boolean {
  if (cachedFp16Support !== null) return cachedFp16Support;
  cachedFp16Support = adapter.features.has("shader-f16");
  return cachedFp16Support;
}
